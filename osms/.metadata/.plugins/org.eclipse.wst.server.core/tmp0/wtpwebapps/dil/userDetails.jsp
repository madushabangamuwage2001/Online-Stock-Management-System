...
<table width="100%" >
     <tr>
     	...
     	<h1 style="margin-left:65px;position:relative;bottom:100px;">Available User</h1>
		...
		<c:param name="name" value="${u.name}"/>
		<c:param name="con" value="${u.contact}"/>
		<c:param name="add" value="${u.address}"/>
		<c:param name="email" value="${u.email}"/>
		<c:param name="nic" value="${u.NIC}"/>
		
		
	</c:url>
   
                <a href="${userupdate}"><button class="button">
				...
				<input type="hidden" name="code" value="${u.id}">
          ...
          <a href="adduser.jsp"><input type="submit" name="adduser" value="Add User" class="add"></a>
