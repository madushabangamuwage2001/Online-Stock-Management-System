...
bottom:700px;
  ...
  font-weight: bold;
  color: white ; /* Use a blue color (you can choose your preferred color) */
...
<div class="topnav">
  ...
  <img src="image/002.png" width="100%">
  ...
  <table border="1" class="t1">
    <tr>
      <td width="200"><a href="admin dashboard.jsp"><button class="buttonStyle" type="button" id="button">Addmin Dashboard</button></a></td>
    </tr>
    <tr>
      <td><a href="smdashboard.jsp"><button class="buttonStyle" type="button" id="button">Stock Manager Dashboard</button></a></td>
    </tr>
    <tr>
